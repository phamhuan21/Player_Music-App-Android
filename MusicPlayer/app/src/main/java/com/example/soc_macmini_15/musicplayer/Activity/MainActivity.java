    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_btn_replay:
                ...
                if (repeatFlag) {
                    Toast.makeText(this, "Đang phát lại đã xóa", Toast.LENGTH_SHORT).show();
                    mediaPlayer.setLooping(false);
                    repeatFlag = false;
                } else {
                    Toast.makeText(this, "Đang phát lại đã thêm", Toast.LENGTH_SHORT).show();
            ...
            case R.id.img_btn_setting:
                if (!playContinueFlag) {
                    ...
                    Toast.makeText(this, "Đã thêm bài hát lặp", Toast.LENGTH_SHORT).show();
                } else {
                    playContinueFlag = false;
                    Toast.makeText(this, "Đã xóa bài hát lặp", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                if (playContinueFlag) {
                    if (currentPosition + 1 < songList.size()) {
                        ...
                        Toast.makeText(MainActivity.this, "Danh sách nghe đã kết thúc", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
